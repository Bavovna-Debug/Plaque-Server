...
(
	...
	plaque_revision		INTEGER						NOT NULL,
/*
	appear_revision     INTEGER                     NULL DEFAULT NULL,
	change_revision     INTEGER                     NULL DEFAULT NULL,
	disappear_revision  INTEGER                     NULL DEFAULT NULL,
*/
...
BEGIN
	...
	LOOP
        ...
        LOOP
    		...
    		RAISE LOG 'Plaque has changed on radar: session=% plaqueId=% plaqueRevision=%',
    		    var_session_id, var_plaque_id, var_plaque_revision;
	    END LOOP;
        ...
        LOOP
    		...
    		RAISE LOG 'Plaque has changed in sight: session=% plaqueId=% plaqueRevision=%',
    		    var_session_id, var_plaque_id, var_plaque_revision;
	    END LOOP;
	END LOOP;
END;

...
#define NUMBER_OF_DB_CONNECTOIONS	10
#define NUMBER_OF_GUARDIANS			3
#define NOTHING						-1
...
{
	constructDBChain(DB_CHAIN_PLAQUES, NUMBER_OF_DB_CONNECTOIONS,
		"hostaddr = '127.0.0.1' dbname = 'plaque' user = 'plaque_admin' password = 'DYnjANGz9jYmvCCTyasUqq2Y'");

	constructDBChain(DB_CHAIN_GUARDIAN, NUMBER_OF_GUARDIANS,
		"hostaddr = '127.0.0.1' dbname = 'guardian' user = 'guardian' password = 'nVUcDYDVZCMaRdCfayWrG23w'");
}

void destructDB(void)
{
	destructDBChain(DB_CHAIN_PLAQUES);
	destructDBChain(DB_CHAIN_GUARDIAN);
}
